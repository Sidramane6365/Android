...
public class RegisterActivity extends DialogFragment implements
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        SelectBtn=(Button) v.findViewById(R.id.selectloc);
        ChangeBtn=(Button) v.findViewById(R.id.changeloc);



        mapFragment = (MapFragment) getFragmentManager().findFragmentById(R.id.shortmap);
